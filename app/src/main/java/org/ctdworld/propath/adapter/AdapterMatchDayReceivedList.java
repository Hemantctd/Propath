...
// this adapter
public class AdapterMatchDayReceivedList extends RecyclerView.Adapter<AdapterMatchDayReceivedList.MyViewHolder>
{
    private final String TAG = AdapterMatchDayReceivedList.class.getSimpleName();
    private Context mContext;
    private OnOptionsMenuClickedListener mListener;


    public AdapterMatchDayReceivedList(Context context, OnOptionsMenuClickedListener listener)
    {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position)
    {
        ...
        holder.mName.setText("Team Name");
