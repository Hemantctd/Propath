...
public class AdapterCareerPlanUser extends RecyclerView.Adapter<AdapterCareerPlanUser.MyViewHolder>
{
    private final String TAG = AdapterCareerPlanUser.class.getSimpleName();
    private Context mContext;
    private List<GetAthletes> mUserList;
    private ContractReviewGotAllAthletes.Presenter mPresenterGetReviewAthletes;

    public AdapterCareerPlanUser(Context context, List<GetAthletes> userList, ContractReviewGotAllAthletes.Presenter presenter)
    {
    ...
    // sending connection request
    private void sendRequest(final MyViewHolder holder, final String userId)
    {
