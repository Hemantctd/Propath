...
public class AdapterFullSizeImageRemoveUnwantedSlider extends PagerAdapter
{
    private static final String TAG = AdapterFullSizeImageRemoveUnwantedSlider.class.getSimpleName();
    Context context;
    private ArrayList<String> mListImagesPath;
    private ArrayList<String> mListRemovedImagesList;
    private ViewPager viewPager;
    private int currentPage;
    private FragmentFullSizeImageRemoveUnwanted fragmentFullSizeImageRemoveUnwanted;
 ...
 /*   public static final int TYPE_GALLERY = 1;
    ...
    public AdapterFullSizeImageRemoveUnwantedSlider(DialogFragment dialogFragment, Context context, ArrayList<String> listUrl, ViewPager viewPager/*, int type*/, FragmentFullSizeImageRemoveUnwanted imagesFullSize)
    {
        this.context = context;
        this.viewPager = viewPager;
        this.mListImagesPath = listUrl;
        this.fragmentFullSizeImageRemoveUnwanted = imagesFullSize;
        this.mDialogFragment = dialogFragment;
        mListRemovedImagesList = new ArrayList<>();
    }


    // this method returns list of removed images
    public List<String> getRemovedImageList()
    {
        return mListRemovedImagesList;
    }
         ...
         //   Log.i(TAG,"instantiateItem = "+listBitmap.size());
            if (true)
            {
              //  Log.i(TAG,"inside gallery ");
                ...
                Glide.with(context)
                        .load(picUrl  /*Integer.valueOf(picUrl)*/ )
                ...
                imgCancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    {
                        // adding removed image to list
                        mListRemovedImagesList.add(mListImagesPath.get(position));
