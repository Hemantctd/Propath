...
public class AdapterNewFeed extends RecyclerView.Adapter<AdapterNewFeed.MyViewHolder> {
    private static final String TAG = AdapterNewFeed.class.getSimpleName();
    private Context mContext;  // activity context
    private List<NewsFeed.PostData> mListPostData;  // contains post data list
    private ContractNewsFeed.Presenter mPresenterNewsFeed;  // presenter to request to server
    private boolean mShowAnimation = true; //
    private List<AdapterNewFeed.MyViewHolder> mHolderList;

    public AdapterNewFeed(Context context, ContractNewsFeed.Presenter presenter) {
        mContext = context;
        mListPostData = new ArrayList<>();
        mPresenterNewsFeed = presenter;
        mHolderList = new ArrayList<>();
    }


    public void addNewsFeedList(List<NewsFeed.PostData> listPostData) {
    ...
    public void filterList(List<NewsFeed.PostData> listPostData) {
        mListPostData = listPostData;
        notifyDataSetChanged();
    }
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        NewsFeed.PostData postData = mListPostData.get(holder.getAdapterPosition());
...
//            mYoutubeFragmentContainer = view.findViewById(R.id.fragment_youtube_container);
    ...
    private void setOnProfileImageClickListener(final NewsFeed.PostData postData, MyViewHolder holder) {
    ...
    private void setOnShareClicked(final NewsFeed.PostData postData, View view) {
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((AppCompatActivity) mContext).startActivityForResult(i, ConstHelper.RequestCode.ACTIVITY_NEWS_FEED_SHARE);
            }
        });
    }
    ...
    private void setLikePost(NewsFeed.PostData postData, MyViewHolder holder) {
    ...
    private void setPostMessage(NewsFeed.PostData postData, MyViewHolder holder) {
    ...
    // # setting total number of likes and comments on post
    private void setLikeCommentCount(NewsFeed.PostData postData, MyViewHolder holder) {
    ...
    private void setProfileImage(NewsFeed.PostData postData, MyViewHolder holder) {
        if (postData == null)
            return;
    ...
    private void setOptionsMenu(NewsFeed.PostData postData, AdapterNewFeed.MyViewHolder holder) {
    ...
    private void setOptionsMenuClickListener(final NewsFeed.PostData postData, final AdapterNewFeed.MyViewHolder holder) {
        // checking if this is shared post or not if this is shared post then the post can not be edited
        final boolean sharedPost = postData.getPostSharedBy() != null && !postData.getPostSharedBy().isEmpty() && !postData.getPostSharedBy().equals(NewsFeed.POST_NOT_SHARED);
    ...
    private void setCommentLayoutClickListener(final NewsFeed.PostData postData, MyViewHolder holder) {
        holder.layoutComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (appCompatActivity != null)
                    appCompatActivity.startActivityForResult(intent, ConstHelper.RequestCode.ACTIVITY_NEWS_FEED_COMMENT);
            }
        });
    }
    ...
    private void setSharedPostData(NewsFeed.PostData postData, MyViewHolder holder) {
    ...
    // # setting post media
    private void setPostMedia(final NewsFeed.PostData postData, final MyViewHolder holder) {
    ...
    private void setLikeClickListener(final NewsFeed.PostData postData, final MyViewHolder holder) {
    ...
    private void likeDislikePost(NewsFeed.PostData postData) {
        if (postData == null || mPresenterNewsFeed == null)
            return;
    ...
    private void showVideo(final AdapterNewFeed.MyViewHolder holder, NewsFeed.PostData postData) {
    ...
    private void showYouTubeVideo(final MyViewHolder holder, final NewsFeed.PostData postData) {
    ...
    private void playYouTubeVideo(AdapterNewFeed.MyViewHolder holder, final String link) {
    ...
    public void onScrollingStopped() {
        for (AdapterNewFeed.MyViewHolder holder : mHolderList) {
