...
public class AdapterCoachViewFeedbackChooseAthlete extends RecyclerView.Adapter<AdapterCoachViewFeedbackChooseAthlete.MyViewHolder> {

    private final String TAG = AdapterCoachFeedbackChooseAthleteName.class.getSimpleName();
    private Context mContext;
    private List<GetAthletes> mUserList;

    public AdapterCoachViewFeedbackChooseAthlete(Context context, List<GetAthletes> userList) {
    ...
    @NonNull
    @Override
    public AdapterCoachViewFeedbackChooseAthlete.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_choose_athlete_name, parent, false);

        return new AdapterCoachViewFeedbackChooseAthlete.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdapterCoachViewFeedbackChooseAthlete.MyViewHolder holder, int position)
    {
        ...
        if (loggedInUser.equals(coachRoleId)) {
            ...
            holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(ActivityCoachFeedback.KEY_IS_FRAGMENT_SINGLE, true);
        ...
        holder.img_send_request.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    String messagePermission = "Without permission you can not see coach feedback";
   ...
   // ActivityCoachFeedbackCoachView
    ...
    public class MyViewHolder  extends RecyclerView.ViewHolder {
        ...
        private ImageView imgUserPic,img_send_request;
    ...
    // sending connection request
    private void sendRequest(final AdapterCoachViewFeedbackChooseAthlete.MyViewHolder holder, final String userId)
    {
        ...
        if (UtilHelper.isConnectedToInternet(mContext))
        {
            holder.img_send_request.setVisibility(View.GONE);
            holder.progressBar.setVisibility(View.VISIBLE);
            presenter.sendRequest(userId, Request.REQUEST_FOR_COACH_FEEDBACK);
        }
        else
