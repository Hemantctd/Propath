...
import org.ctdworld.propath.adapter.AdapterFreeResponseQuestionsWithOptions;
...
public class ActivitySurveyFreeResponseWithOptions extends AppCompatActivity implements View.OnClickListener,AdapterFreeResponseQuestionsWithOptions.OnAdapterSurveyFreeResponseListener{
    public static final String TAG =  ActivitySurveyFreeResponseWithOptions.class.getSimpleName();
   ...
   /* public static final String SURVEY_QUESTIONS_LIST =  "survey_questions_items";
    ...
    AdapterFreeResponseQuestionsWithOptions mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mBundle != null) {
            ...
            if (surveyFreeResponse != null) {
                questionsList = surveyFreeResponse.getQuestionsList();
            }
        }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_next) {
            List<Survey.SurveyData.FreeResponse.Questions> list = mAdapter.getSurveyQusetions();
            ...
            if (mSurveyType.equals(ActivityCreateSurvey.SURVEY_TYPE_EDIT)) {
                ...
                intent.putExtra(ActivityCreateSurvey.SURVEY_FREE_RESPONSE, surveyFreeResponse);
    ...
    private void prepareRecyclerView()
    {
        ...
        mAdapter = new AdapterFreeResponseQuestionsWithOptions(mContext, questionsList, this);
    ...
    private void prepareToolbar()
    {
        ...
        mTxtToolbarTitle.setText(R.string.survey_questions);
    ...
    private void selectMedia() {
       // String permissionTitle = "Permission Required";
        ...
        if (permissionHelper.isPermissionGranted(Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            startActivityForResult(intent, ActivitySurveyFreeResponseWithOptions.REQUEST_CODE_IMAGE_FROM_ADAPTER);
        } else {
    ...
    private void cropImage(Uri uri)
    {
        ...
        try {
            UCrop.of(uri, Uri.parse(FileHelper.getFilePath(mContext, uri)))
                    ...
                    .start(ActivitySurveyFreeResponseWithOptions.this);
