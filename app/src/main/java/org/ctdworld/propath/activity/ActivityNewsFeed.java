...
public class ActivityNewsFeed extends BaseActivity implements ContractNewsFeed.View, FragmentSearch.SearchListener {
    // # Constants
    private static final String TAG = ActivityNewsFeed.class.getSimpleName();  // tag used in log
    ...
    private View.OnClickListener onFloatButtonClicked = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent i = new Intent(new Intent(ActivityNewsFeed.this, ActivityNewsFeedPost.class));
